export const projectsData = [
  {
    ...
    description:
      'A logistics management system for a company to manage their logistics operations.',
    slug: 'logistics',
    images: [
  ...
  },
  {
    ...
    description:
      'A Gaming Cafe management software to manage and track sales, expenses and inventory.',
  ...
  },
  {
    ...
    title: 'SKZ Portfolio',
    description:
      'A portfolio website built using Next.js, Tailwind CSS, and Framer Motion. It features a clean and modern design.',
    slug: 'skz-portfolio',
    images: [
      '/Projects/SKZ/1.png',
      '/Projects/SKZ/2.png',
  ...
  },
  {
    ...
    title: '2 Player Game',
    description:
      'A Desktop two player game. Player 1 - WASD(Movement) & Spacebar(Attack), Player 2 - Arrow Keys(Movement) & Enter(Attack).',
    slug: '2-player-game',
    images: [
      '/Projects/Game/1.png',
      '/Projects/Game/2.png',
  ...
  },
  {
    ...
    slug: 'electrotech',
    images: [
      '/Projects/ElectroTech/1.png',
      '/Projects/ElectroTech/2.png',
      '/Projects/ElectroTech/3.png'
    ],
